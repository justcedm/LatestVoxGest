"""Audit the FullSign225 manual15 dataset view.

The manual15 profile intentionally reads the existing manual16 webcam feature
folder, ignores paused WANT samples, and validates only the stable 15-label set.
"""
...
os.environ.setdefault("VOXGEST_WORD_PROFILE", "fullsign225_manual15")
...
CSV_OUT = REPORT_DIR / "fullsign225_manual15_audit.csv"
JSON_OUT = REPORT_DIR / "fullsign225_manual15_audit.json"
MD_OUT = REPORT_DIR / "fullsign225_manual15_audit.md"
...
def write_markdown(payload):
    ...
    lines = [
        "# FullSign225 Manual15 Dataset Audit",
        "",
        ...
        f"Paused labels ignored by this audit: {', '.join(payload['paused_labels'])}",
        "",
        "## Summary",
        "",
    ...
    lines.extend(
        [
            ...
            "## Training Rule",
            "",
            "Do not train `fullsign225_manual15` until every readiness gate passes. "
            "WANT is paused because it currently has too few stable samples and is "
...
def main():
    ...
    print("=" * 72)
    print("FullSign225 manual15 audit")
    print("=" * 72)
