...
echo ============================================================
echo  VoxGest FullSign225 Phrase V1 - Extra Phrase Words
echo ============================================================
...
set VOXGEST_SIGNER_ID=ANASTACIA
...
echo Words           : STUDENT WHERE LIVE
echo Target          : 30 accepted samples per word
echo.

recorder_env\Scripts\python.exe scripts_ml\41_record_manual_fullsign225_words.py STUDENT WHERE LIVE
if errorlevel 1 (
    echo.
...
echo.
echo Done recording FullSign225 phrase extra words.
pause
